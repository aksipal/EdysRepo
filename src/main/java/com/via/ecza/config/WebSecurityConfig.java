...
import com.via.ecza.jwt.JwtAuthenticationEntryPoint;
import com.via.ecza.jwt.JwtAuthorizationFilter;
...
//                .antMatchers(HttpMethod.POST,"/api/registration").permitAll()
                ...
                .antMatchers("/api/supplier/**","/api/stock/**", "/api/depot/**", "/api/order-acceptance/**", "/api/stock-counting/**", "/api/communication/**", "/api/box/**", "/api/small-box/**", "/api/refund-acceptance/**").hasAnyAuthority("ROLE_WAREHOUSEMAN", "ROLE_ADMIN","ROLE_PURCHASE", "ROLE_LOGISTIC")
