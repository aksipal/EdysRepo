...
@Setter
@Entity
@Table(name="pre_depot")
public class PreDepot {


    @Id
    @SequenceGenerator(name = "sq_pre_depot", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sq_pre_depot")
    @Column(name = "pre_depot_id")
    ...
    @JoinColumn(name = "preDepotStatusId", referencedColumnName = "pre_depot_status_id", nullable = false)
